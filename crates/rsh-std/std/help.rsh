...
def "rsh-complete list-commands" [] {
    scope commands | select name usage | rename value description
}

def "rsh-complete list-externs" [] {
...
#        ╰────
export def modules [
    ...module: string@"rsh-complete list-modules"  # the name of module to get help on
...
#        ╰────
export def aliases [
    ...alias: string@"rsh-complete list-aliases"  # the name of alias to get help on
...
export def externs [
    ...extern: string@"rsh-complete list-externs"  # the name of extern to get help on
...
export def operators [
    ...operator: string@"rsh-complete list-operators"  # the name of operator to get help on
...
export def commands [
    ...command: string@"rsh-complete list-commands"  # the name of command to get help on
    ...
    if not ($find | is-empty) {
        ...
        if ($found_command | is-empty) {
            try {
                ...
                ^($env.RSH_HELPER? | default "man") $target_command
            } catch {
...
rsh works on the idea of a "(ansi default_italic)pipeline(ansi reset)". Pipelines are commands connected with the '|' character.
Each stage in the pipeline works together to load, parse, and display information to you.

(ansi green)Examples(ansi reset):
    List the files in the current directory, sorted by size
    > ('ls | sort-by size' | rsh-highlight)

    Get information about the current system
    > ('sys | get host' | rsh-highlight)
