...
use rsh_protocol::{Config, Span, TableIndexMode, TableMode};

use crate::{common::INDEX_COLUMN_NAME, RshTable};
...
impl TableOutput {
    pub fn new(table: RshTable, with_header: bool, with_index: bool) -> Self {
        Self {
            table,
            with_header,
            with_index,
