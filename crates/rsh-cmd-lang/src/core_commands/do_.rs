...
use rsh_engine::{eval_block_with_early_return, redirect_env, CallExt};
    ...
    fn examples(&self) -> Vec<Example> {
        vec![
            ...
            Example {
                ...
                example: r#"do --ignore-program-errors { rsh --commands 'exit 1' }; echo "I'll still run""#,
                result: None,
            },
            Example {
                description: "Abort the pipeline if a program returns a non-zero exit code",
                example: r#"do --capture-errors { rsh --commands 'exit 1' } | myscarycommand"#,
                result: None,
            },
            Example {
