use rsh_engine::{eval_block, eval_expression, eval_expression_with_input, CallExt};
use rsh_protocol::ast::Call;
use rsh_protocol::engine::{Block, Command, EngineState, Stack, StateWorkingSet};
use rsh_protocol::eval_const::{eval_const_subexpression, eval_constant, eval_constant_with_input};
use rsh_protocol::{
