use rsh_engine::{eval_block, find_in_dirs_env, get_dirs_var_from_call, redirect_env, CallExt};
use rsh_parser::trim_quotes_str;
  ...
  https://irsh.eu.org/book/thinking_in_nu.html"#
    ...
    spam foo"#,
            ...
            Example {
                ...
                example: r#"'export-env { $env.FOO = "foo" }' | save spam.rsh
