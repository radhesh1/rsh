    ...
    fn examples(&self) -> Vec<Example> {
        vec![
            ...
            Example {
                ...
                example:
                    "{shell:'true', uwu:true, features: {bugs:false, multiplatform:true, speed: 10}, fib: [1 1 2 3 5 8], on_save: {|x| print $'Saving ($x)'}, first_commit: 2023-11-26, my_duration: (4min + 20sec)} | describe -d",
...
fn metadata_to_value(metadata: Option<Box<PipelineMetadata>>, head: rsh_protocol::Span) -> Value {
    match metadata {
