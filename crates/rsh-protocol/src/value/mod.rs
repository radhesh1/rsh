...
use rsh_utils::locale::get_system_locale_string;
use rsh_utils::{get_system_locale, IgnoreCaseExt};
...
/// Core structured values that pass through the pipeline in rsh.
