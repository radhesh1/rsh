...
/// Definition of a rsh CursorShape (to be mapped to crossterm::cursor::CursorShape)
#[derive(Serialize, Deserialize, Clone, Debug, Copy, Default)]
pub enum RshCursorShape {
    UnderScore,
    Line,
    Block,
    BlinkUnderScore,
...
impl FromStr for RshCursorShape {
    type Err = &'static str;

    fn from_str(s: &str) -> Result<RshCursorShape, &'static str> {
        match s.to_ascii_lowercase().as_str() {
        "line" => Ok(RshCursorShape::Line),
        "block" => Ok(RshCursorShape::Block),
        "underscore" => Ok(RshCursorShape::UnderScore),
        "blink_line" => Ok(RshCursorShape::BlinkLine),
        "blink_block" => Ok(RshCursorShape::BlinkBlock),
        "blink_underscore" => Ok(RshCursorShape::BlinkUnderScore),
        "inherit" => Ok(RshCursorShape::Inherit),
        _ => Err("expected either 'line', 'block', 'underscore', 'blink_line', 'blink_block', 'blink_underscore' or 'inherit'"),
        }
    }
}

impl ReconstructVal for RshCursorShape {
    fn reconstruct_value(&self, span: Span) -> Value {
        Value::string(
            match self {
                RshCursorShape::Line => "line",
                RshCursorShape::Block => "block",
                RshCursorShape::UnderScore => "underscore",
                RshCursorShape::BlinkLine => "blink_line",
                RshCursorShape::BlinkBlock => "blink_block",
                RshCursorShape::BlinkUnderScore => "blink_underscore",
                RshCursorShape::Inherit => "inherit",
            },
            span,
        )
    }
        ...
        config
            ...
            .map(
                |ParsedMenu {
                     ...
                     marker,
                     style,
                     menu_type, // WARNING: this is not the same name as what is used in Config.rsh! ("type")
                     source,
                 }| {
                    Value::record(
                        record! {
