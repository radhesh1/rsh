...
use rsh_utils::{stderr_write_all_and_flush, stdout_write_all_and_flush};
...
///
/// * We tried always assuming a stream in rsh. This was a great 80% solution, but it had some rough edges.
