#[cfg(test)]
use rsh_protocol::engine::Command;
...
mod test_examples {
    ...
    use rsh_cmd_lang::example_support::{
    ...
    fn make_engine_state(cmd: Box<dyn Command>) -> Box<EngineState> {
        ...
        let delta = {
            ...
            working_set.add_decl(Box::new(rsh_command::Enumerate));
            working_set.add_decl(Box::new(rsh_cmd_lang::If));
            working_set.add_decl(Box::new(rsh_command::MathRound));
