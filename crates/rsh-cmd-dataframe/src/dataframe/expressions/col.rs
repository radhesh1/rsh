...
impl Command for ExprCol {
    ...
    fn examples(&self) -> Vec<Example> {
        vec![Example {
            description: "Creates a named column expression and converts it to a rsh object",
    ...
    fn run(
        ...
        let expr: rshExpression = col(name.as_str()).into();
...
mod test {
    ...
    #[test]
    fn test_examples() {
        test_dataframe(vec![Box::new(ExprCol {}), Box::new(ToRsh {})])
    }
}
