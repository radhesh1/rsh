...
use rsh_color_config::{get_matching_brackets_style, get_shape_color};
use rsh_parser::{flatten_block, parse, FlatShape};
use rsh_protocol::ast::{Argument, Block, Expr, Expression, PipelineElement};
use rsh_protocol::engine::{EngineState, StateWorkingSet};
use rsh_protocol::{Config, Span};
use reedline::{Highlighter, StyledText};
use std::sync::Arc;

pub struct RshHighlighter {
    pub engine_state: Arc<EngineState>,
    pub config: Config,
}

impl Highlighter for RshHighlighter {
