...
use rsh_protocol::{engine::EngineState, levenshtein_distance};
use rsh_utils::IgnoreCaseExt;
use reedline::{Completer, Suggestion};
use std::fmt::Write;
use std::sync::Arc;

pub struct RshHelpCompleter(Arc<EngineState>);

impl RshHelpCompleter {
...
impl Completer for RshHelpCompleter {
