use crate::RshPrompt;
use log::trace;
use rsh_engine::eval_subexpression;
...
pub(crate) fn update_prompt<'prompt>(
    ...
    engine_state: &EngineState,
    stack: &Stack,
    rsh_prompt: &'prompt mut RshPrompt,
) -> &'prompt dyn Prompt {
    ...
    rsh_prompt.update_all_prompt_strings(
        left_prompt_string,
        right_prompt_string,
    ...
    let ret_val = rsh_prompt as &dyn Prompt;
...
impl Prompt for TransientPrompt {
    fn render_prompt_left(&self) -> Cow<str> {
        ...
        rsh_prompt.update_prompt_left(get_transient_prompt_string(
        ...
        rsh_prompt.render_prompt_left().to_string().into()
    }
    ...
    fn render_prompt_right(&self) -> Cow<str> {
        ...
        let config = &self.engine_state.get_config().clone();
        let mut stack = self.stack.clone();
        rsh_prompt.update_prompt_right(
        ...
        rsh_prompt.render_prompt_right().to_string().into()
    }
    ...
    fn render_prompt_indicator(&self, prompt_mode: reedline::PromptEditMode) -> Cow<str> {
        ...
        let config = &self.engine_state.get_config().clone();
        let mut stack = self.stack.clone();
        rsh_prompt.update_prompt_indicator(get_transient_prompt_string(
        ...
        rsh_prompt.update_prompt_vi_insert(get_transient_prompt_string(
            TRANSIENT_PROMPT_INDICATOR_VI_INSERT,
        ...
        rsh_prompt.update_prompt_vi_normal(get_transient_prompt_string(
            TRANSIENT_PROMPT_INDICATOR_VI_NORMAL,
    ...
    fn render_prompt_multiline_indicator(&self) -> Cow<str> {
        ...
        let config = &self.engine_state.get_config().clone();
        let mut stack = self.stack.clone();
        rsh_prompt.update_prompt_multiline(get_transient_prompt_string(
            TRANSIENT_PROMPT_MULTILINE_INDICATOR,
