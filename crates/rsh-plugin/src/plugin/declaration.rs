...
use rsh_protocol::{ast::Call, PluginSignature, Signature};
use rsh_protocol::{Example, PipelineData, ShellError, Value};
...
impl Command for PluginDeclaration {
    ...
    fn run(
        ...
        let current_envs = rsh_engine::env::env_to_strings(engine_state, stack).unwrap_or_default();
