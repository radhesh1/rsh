...
use rsh_protocol::{PluginSignature, ShellError, Span, Value};
...
/// An error message with debugging information that can be passed to rsh from the plugin
///
...
// Needs to be public to communicate with rsh-parser but not typically
