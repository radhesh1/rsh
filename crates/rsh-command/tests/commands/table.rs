...
#[test]
fn table_0() {
    let actual = rsh!("[[a b, c]; [1 2 3] [4 5 [1 2 3]]] | table --width=80");
    assert_eq!(
        actual.out,
        "╭───┬───┬───┬────────────────╮\
         │ # │ a │ b │       c        │\
...
#[test]
fn table_collapse_0() {
    let actual = rsh!("[[a b, c]; [1 2 3] [4 5 [1 2 3]]] | table --width=80 --collapse");
    assert_eq!(
        actual.out,
        "╭───┬───┬───╮\
         │ a │ b │ c │\
...
#[test]
fn table_expand_0() {
    let actual = rsh!("[[a b, c]; [1 2 3] [4 5 [1 2 3]]] | table --width=80 --expand");
    assert_eq!(
        actual.out,
        "╭───┬───┬───┬───────────╮\
         │ # │ a │ b │     c     │\
...
fn table_expand_exceed_overlap_0() {
    ...
    let actual =
        rsh!("[[a b, c]; [xxxxxxxxxxxxxxxxxxxxxx 2 3] [4 5 [1 2 3]]] | table --width=80 --expand");
...
fn table_expand_deep_0() {
    let actual =
        rsh!("[[a b, c]; [1 2 3] [4 5 [1 2 [1 2 3]]]] | table --width=80 --expand --expand-deep=1");
    assert_eq!(
        actual.out,
        "╭───┬───┬───┬────────────────────────╮\
         │ # │ a │ b │           c            │\
...
fn table_expand_deep_1() {
    let actual =
        rsh!("[[a b, c]; [1 2 3] [4 5 [1 2 [1 2 3]]]] | table --width=80 --expand --expand-deep=0");
    assert_eq!(
        actual.out,
        "╭───┬───┬───┬────────────────╮\
         │ # │ a │ b │       c        │\
...
fn table_expand_flatten_0() {
    let actual =
        rsh!("[[a b, c]; [1 2 3] [4 5 [1 2 [1 1 1]]]] | table --width=80 --expand --flatten ");
    assert_eq!(
        actual.out,
        "╭───┬───┬───┬───────────────╮\
         │ # │ a │ b │       c       │\
...
fn table_expand_record_0() {
    let actual = rsh!("[{c: {d: 1}}] | table --width=80 --expand");
...
fn table_expand_record_1() {
    let actual =
        rsh!("[[a b, c]; [1 2 3] [4 5 [1 2 {a: 123, b: 234, c: 345}]]] | table --width=80 --expand");
...
fn table_expand_record_2() {
    ...
    let actual = rsh!(format!("{structure} | table --width=80 --expand"));
...
#[test]
#[cfg(not(windows))]
fn external_with_too_much_stdout_should_not_hang_rsh() {
    use rsh_test_support::fs::Stub::FileWithContent;
...
fn test_expand_big_0() {
    Playground::setup("test_expand_big_0", |dirs, sandbox| {
        sandbox.with_files(vec![FileWithContent(
            ...
            documentation = "https://iirsh.vercel.app/book/"
            edition = "2021"
            exclude = ["images"]
            homepage = "https://iirsh.vercel.app"
            license = "MIT"
            name = "rsh"
            ...
            rsh-ansi-term = "0.46.0"
            rsh-cli = { path = "./crates/rsh-cli", version = "0.74.1" }
            rsh-engine = { path = "./crates/rsh-engine", version = "0.74.1" }
            ...
            [dev-dependencies]
            rsh-test-support = { path = "./crates/rsh-test-support", version = "0.74.1" }
            tempfile = "3.2.0"
            assert_cmd = "2.0.2"
            criterion = "0.4"
            ...
            # Stable (Default)
            which-support = ["rsh-command/which-support"]
            trash-support = ["rsh-command/trash-support"]
        ...
        let expected = join_lines([
            ...
            "│                  │ │ rsh-ansi-term  │ 0.46.0                                │ │",
            "│                  │ │               │ ╭─────────┬─────────────────╮         │ │",
            "│                  │ │ rsh-cli        │ │ path    │ ./crates/rsh-cli │         │ │",
            "│                  │ │               │ │ version │ 0.74.1          │         │ │",
            "│                  │ │               │ ╰─────────┴─────────────────╯         │ │",
            "│                  │ │               │ ╭────────────┬──────────────────────╮ │ │",
            "│                  │ │ rsh-engine     │ │ path       │ ./crates/rsh-engine   │ │ │",
            "│                  │ │               │ │ version    │ 0.74.1               │ │ │",
            "│                  │ │               │ ╰────────────┴──────────────────────╯ │ │",
            "│                  │ │ rayon         │ 1.6.1                                 │ │",
            "│                  │ │               │ ╭─────────────┬─────────────────────╮ │ │",
            ...
            "│                  │ │ itertools         │ 0.10.3                            │ │",
            "│                  │ │                   │ ╭─────────┬─────────────────────╮ │ │",
            "│                  │ │ rsh-test-support   │ │ path    │ ./crates/rsh-test-su │ │ │",
            "│                  │ │                   │ │         │ pport               │ │ │",
            "│                  │ │                   │ │ version │ 0.74.1              │ │ │",
            "│                  │ │                   │ ╰─────────┴─────────────────────╯ │ │",
            "│                  │ │ pretty_assertions │ 1.0.0                             │ │",
            ...
            "│                  │ │                     │ │ 1 │ rsh-cli/plugin      │      │ │",
            "│                  │ │                     │ │ 2 │ rsh-parser/plugin   │      │ │",
            "│                  │ │                     │ │ 3 │ rsh-command/plugin  │      │ │",
            "│                  │ │                     │ │ 4 │ rsh-protocol/plugin │      │ │",
            "│                  │ │                     │ │ 5 │ rsh-engine/plugin   │      │ │",
            "│                  │ │                     │ ╰───┴────────────────────╯      │ │",
            "│                  │ │                     │ ╭───┬─────────╮                 │ │",
            "│                  │ │ stable              │ │ 0 │ default │                 │ │",
            ...
            "│                  │ │                     │ ╰───┴─────────────╯             │ │",
            "│                  │ │                     │ ╭───┬─────────────────────────╮ │ │",
            "│                  │ │ trash-support       │ │ 0 │ rsh-command/trash-suppor │ │ │",
            "│                  │ │                     │ │   │ t                       │ │ │",
            "│                  │ │                     │ ╰───┴─────────────────────────╯ │ │",
            "│                  │ │ wasi                │ [list 0 items]                  │ │",
            "│                  │ │                     │ ╭───┬─────────────────────────╮ │ │",
            "│                  │ │ which-support       │ │ 0 │ rsh-command/which-suppor │ │ │",
            "│                  │ │                     │ │   │ t                       │ │ │",
            "│                  │ │                     │ ╰───┴─────────────────────────╯ │ │",
            "│                  │ ╰─────────────────────┴─────────────────────────────────╯ │",
            "│                  │ ╭───────────────┬───────────────────────────────────────╮ │",
            "│ package          │ │               │ ╭───┬───────────────────────────────╮ │ │",
            "│                  │ │ authors       │ │ 0 │ The rsh Project           │ │ │",
            "│                  │ │               │ │   │ Developers                    │ │ │",
            "│                  │ │               │ ╰───┴───────────────────────────────╯ │ │",
            "│                  │ │ default-run   │ rsh                                    │ │",
            "│                  │ │ description   │ A new type of shell                   │ │",
            ...
            "│                  │ ╭───────────┬───────────────────────────────────────────╮ │",
            "│ workspace        │ │           │ ╭────┬────────────────────────────────╮   │ │",
            "│                  │ │ members   │ │  0 │ crates/rsh-cli                  │   │ │",
            "│                  │ │           │ │  1 │ crates/rsh-engine               │   │ │",
            "│                  │ │           │ │  2 │ crates/rsh-parser               │   │ │",
            "│                  │ │           │ │  3 │ crates/rsh-system               │   │ │",
            "│                  │ │           │ │  4 │ crates/rsh-command              │   │ │",
            "│                  │ │           │ │  5 │ crates/rsh-protocol             │   │ │",
            "│                  │ │           │ │  6 │ crates/rsh-plugin               │   │ │",
            "│                  │ │           │ │  7 │ crates/rsh_plugin_inc           │   │ │",
            "│                  │ │           │ │  8 │ crates/rsh_plugin_gstat         │   │ │",
            "│                  │ │           │ │  9 │ crates/rsh_plugin_example       │   │ │",
            "│                  │ │           │ │ 10 │ crates/rsh_plugin_query         │   │ │",
            "│                  │ │           │ │ 11 │ crates/rsh_plugin_custom_values │   │ │",
            "│                  │ │           │ │ 12 │ crates/rsh-utils                │   │ │",
            "│                  │ │           │ ╰────┴────────────────────────────────╯   │ │",
            "│                  │ ╰───────────┴───────────────────────────────────────────╯ │",
            "╰──────────────────┴───────────────────────────────────────────────────────────╯",
        ...
        let expected = join_lines([
            ...
            "│                  │ │ itertools         │ 0.10.3                                 │                                    │",
            "│                  │ │                   │ ╭─────────┬──────────────────────────╮ │                                    │",
            "│                  │ │ rsh-test-support   │ │ path    │ ./crates/rsh-test-support │ │                                    │",
            "│                  │ │                   │ │ version │ 0.74.1                   │ │                                    │",
            "│                  │ │                   │ ╰─────────┴──────────────────────────╯ │                                    │",
            "│                  │ │ pretty_assertions │ 1.0.0                                  │                                    │",
            "│                  │ │                   │ ╭──────────────────┬────────╮          │                                    │",
            ...
            "│                  │ │                     │ ╰───┴─────────────╯              │                                        │",
            "│                  │ │                     │ ╭───┬──────────────────────────╮ │                                        │",
            "│                  │ │ trash-support       │ │ 0 │ rsh-command/trash-support │ │                                        │",
            "│                  │ │                     │ ╰───┴──────────────────────────╯ │                                        │",
            "│                  │ │ wasi                │ [list 0 items]                   │                                        │",
            "│                  │ │                     │ ╭───┬──────────────────────────╮ │                                        │",
            "│                  │ │ which-support       │ │ 0 │ rsh-command/which-support │ │                                        │",
            "│                  │ │                     │ ╰───┴──────────────────────────╯ │                                        │",
            "│                  │ ╰─────────────────────┴──────────────────────────────────╯                                        │",
            "│                  │ ╭───────────────┬───────────────────────────────────────────────────────────────────────────────╮ │",
            "│ package          │ │               │ ╭───┬────────────────────────────────╮                                        │ │",
            "│                  │ │ authors       │ │ 0 │ The rsh Project Developers │                                        │ │",
            "│                  │ │               │ ╰───┴────────────────────────────────╯                                        │ │",
            "│                  │ │ default-run   │ rsh                                                                            │ │",
            "│                  │ │ description   │ A new type of shell                                                           │ │",
            "│                  │ │ documentation │ https://iirsh.vercel.app/book/                                                  │ │",
            ...
            "│                  │ │ crates-io │ │                 │ ╭────────┬─────────────────────────────────────────╮        │ │ │",
            "│                  │ │           │ │ reedline        │ │ branch │ main                                    │        │ │ │",
            "│                  │ │           │ │                 │ │ git    │ https://github.com/radhesh1/reedline.git │        │ │ │",
            "│                  │ │           │ │                 │ ╰────────┴─────────────────────────────────────────╯        │ │ │",
            "│                  │ │           │ ╰─────────────────┴─────────────────────────────────────────────────────────────╯ │ │",
            "│                  │ ╰───────────┴───────────────────────────────────────────────────────────────────────────────────╯ │",
            "│                  │ ╭─────────────────────────────────┬─────────────────────────────────────────────────────────────╮ │",
...
fn table_expande_with_no_header_internally_1() {
    ...
    let actual = rsh!(format!("{} | table --expand --width 136", rsh_value.trim()));
...
fn test_collapse_big_0() {
    Playground::setup("test_expand_big_0", |dirs, sandbox| {
        ...
        let expected = join_lines([
            ...
            "│                  │ which-support       │ rsh-command/which-support            │",
            "├──────────────────┼───────────────┬─────┴─────────────────────────────────────┤",
            "│ package          │ authors       │ The rsh Project Developers            │",
            "│                  ├───────────────┼───────────────────────────────────────────┤",
            "│                  │ default-run   │ rsh                                        │",
            "│                  ├───────────────┼───────────────────────────────────────────┤",
            "│                  │ description   │ A new type of shell                       │",
            ...
            "│                  │ cfg(windows)                    │ ...                     │",
            "├──────────────────┼─────────┬───────────────────────┴─────────────────────────┤",
            "│ workspace        │ members │ crates/rsh-cli                                   │",
            "│                  │         ├─────────────────────────────────────────────────┤",
            "│                  │         │ crates/rsh-engine                                │",
            "│                  │         ├─────────────────────────────────────────────────┤",
            "│                  │         │ crates/rsh-parser                                │",
...
fn table_expand_index_offset() {
    let actual = rsh!("1..1002 | table --width=80 --expand");
...
fn table_index_offset() {
    let actual = rsh!("1..1002 | table --width=80");
    let suffix = "╭──────┬──────╮│ 1000 │ 1001 ││ 1001 │ 1002 │╰──────┴──────╯";
    let expected_suffix = actual.out.strip_suffix(suffix);
    assert!(expected_suffix.is_some(), "{:?}", actual.out);
}
...
fn table_padding_not_default() {
    let actual =
        rsh!("$env.config.table.padding = 5; [[a b, c]; [1 2 3] [4 5 [1 2 3]]] | table --width=80");
    assert_eq!(
        actual.out,
        "╭───────────┬───────────┬───────────┬────────────────────────╮\
         │     #     │     a     │     b     │           c            │\
...
fn table_expand_padding_zero() {
    let actual = rsh!("$env.config.table.padding = {left: 0, right: 0}; [[a b, c]; [1 2 3] [4 5 [1 2 3]]] | table --width=80 -e");
    assert_eq!(
        actual.out,
        "╭─┬─┬─┬─────╮\
         │#│a│b│  c  │\
...
fn table_collapse_padding_zero() {
    let actual = rsh!("$env.config.table.padding = {left: 0, right: 0}; [[a b, c]; [1 2 3] [4 5 [1 2 3]]] | table --width=80 -c");
    assert_eq!(
        actual.out,
        "╭─┬─┬─╮\
         │a│b│c│\
...
fn table_expand_inner_index_0() {
    let actual = rsh!("0..1000 | each {[0]} | table -e");
...
#[test]
fn table_theme_arg() {
    let actual = rsh!("[[a b, c]; [1 2 3] [4 5 [1 2 3]] [1 2 3]] | table --width=80 --theme light");
    assert_eq!(actual.out, " #   a   b         c        ──────────────────────────── 0   1   2                3  1   4   5   [list 3 items]  2   1   2                3 ");

    let actual = rsh!(theme_cmd(
        "basic",
        false,
...
#[test]
fn table_index_arg() {
    let actual = rsh!("[[a b]; [1 2] [2 [4 4]]] | table --width=80 --theme basic -i false");
    assert_eq!(actual.out, "+---+----------------+| a |       b        |+---+----------------+| 1 |              2 |+---+----------------+| 2 | [list 2 items] |+---+----------------+");

    let actual = rsh!("[[a b]; [1 2] [2 [4 4]]] | table --width=80 --theme basic -i true");
    assert_eq!(actual.out, "+---+---+----------------+| # | a |       b        |+---+---+----------------+| 0 | 1 |              2 |+---+---+----------------+| 1 | 2 | [list 2 items] |+---+---+----------------+");

    let actual = rsh!("[[a b]; [1 2] [2 [4 4]]] | table --width=80 --theme basic -i 10");
    assert_eq!(actual.out, "+----+---+----------------+|  # | a |       b        |+----+---+----------------+| 10 | 1 |              2 |+----+---+----------------+| 11 | 2 | [list 2 items] |+----+---+----------------+");
}

#[test]
fn table_expand_index_arg() {
    let actual = rsh!("[[a b]; [1 2] [2 [4 4]]] | table --width=80 --theme basic --expand -i false");
    assert_eq!(actual.out, "+---+-------+| a |   b   |+---+-------+| 1 |     2 |+---+-------+| 2 | +---+ ||   | | 4 | ||   | +---+ ||   | | 4 | ||   | +---+ |+---+-------+");

    let actual = rsh!("[[a b]; [1 2] [2 [4 4]]] | table --width=80 --theme basic --expand -i true");
    assert_eq!(actual.out, "+---+---+-----------+| # | a |     b     |+---+---+-----------+| 0 | 1 |         2 |+---+---+-----------+| 1 | 2 | +---+---+ ||   |   | | 0 | 4 | ||   |   | +---+---+ ||   |   | | 1 | 4 | ||   |   | +---+---+ |+---+---+-----------+");

    let actual = rsh!("[[a b]; [1 2] [2 [4 4]]] | table --width=80 --theme basic --expand -i 10");
    assert_eq!(actual.out, "+----+---+-----------+|  # | a |     b     |+----+---+-----------+| 10 | 1 |         2 |+----+---+-----------+| 11 | 2 | +---+---+ ||    |   | | 0 | 4 | ||    |   | +---+---+ ||    |   | | 1 | 4 | ||    |   | +---+---+ |+----+---+-----------+");
}

#[test]
fn table_list() {
    let actual = rsh!("table --list");
    ...
    let actual = rsh!("ls | table --list");
    assert_eq!(actual.out, "╭────┬────────────────╮│  0 │ basic          ││  1 │ compact        ││  2 │ compact_double ││  3 │ default        ││  4 │ heavy          ││  5 │ light          ││  6 │ none           ││  7 │ reinforced     ││  8 │ rounded        ││  9 │ thin           ││ 10 │ with_love      ││ 11 │ psql           ││ 12 │ markdown       ││ 13 │ dots           ││ 14 │ restructured   ││ 15 │ ascii_rounded  ││ 16 │ basic_compact  │╰────┴────────────────╯");

    let actual = rsh!("table --list --theme basic");
    assert_eq!(actual.out, "╭────┬────────────────╮│  0 │ basic          ││  1 │ compact        ││  2 │ compact_double ││  3 │ default        ││  4 │ heavy          ││  5 │ light          ││  6 │ none           ││  7 │ reinforced     ││  8 │ rounded        ││  9 │ thin           ││ 10 │ with_love      ││ 11 │ psql           ││ 12 │ markdown       ││ 13 │ dots           ││ 14 │ restructured   ││ 15 │ ascii_rounded  ││ 16 │ basic_compact  │╰────┴────────────────╯");
}
