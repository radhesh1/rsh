...
Rsh works on the idea of a "pipeline". Pipelines are commands connected with the '|' character.
...
pub fn highlight_search_string(
    ...
    let stripped_haystack = rsh_utils::strip_ansi_likely(haystack);
