    ...
    fn examples(&self) -> Vec<Example> {
        vec![
            Example {
                ...
                example: "[[lib, extension]; [rsh-lib, rs] [rsh-core, rb]] | drop column",
                result: Some(Value::test_list(vec![
                    Value::test_record(record! { "lib" => Value::test_string("rsh-lib") }),
                    Value::test_record(record! { "lib" => Value::test_string("rsh-core") }),
                ])),
            },
            Example {
                description: "Remove the last column of a record",
                example: "{lib: rsh-lib, extension: rs} | drop column",
                result: Some(Value::test_record(
                    record! { "lib" => Value::test_string("rsh-lib") },
                )),
            },
        ]
    }
