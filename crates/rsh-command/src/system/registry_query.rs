...
fn reg_value_to_nu_string(
    ...
    // don't handle them, so they won't work in Rsh unless we expand them here. Eagerly expanding the
...
fn reg_value_to_nu_list_string(reg_value: winreg::RegValue, call_span: Span) -> rsh_protocol::Value {
...
fn reg_value_to_nu_int(reg_value: winreg::RegValue, call_span: Span) -> rsh_protocol::Value {
    let value =
        match reg_value.vtype {
            // See discussion here https://github.com/radhesh1/rsh/pull/10806#issuecomment-1791832088
