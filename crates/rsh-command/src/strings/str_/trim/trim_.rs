    ...
    fn examples(&self) -> Vec<Example> {
        vec![
            Example {
                ...
                example: "'Rsh shell ' | str trim",
                result: Some(Value::test_string("Rsh shell")),
            },
            Example {
                description: "Trim a specific character",
                example: "'=== Rsh shell ===' | str trim --char '=' | str trim",
                result: Some(Value::test_string("Rsh shell")),
            },
            Example {
                description: "Trim whitespace from the beginning of string",
                example: "' Rsh shell ' | str trim --left",
                result: Some(Value::test_string("Rsh shell ")),
            },
            Example {
                description: "Trim a specific character",
                example: "'=== Rsh shell ===' | str trim --char '='",
                result: Some(Value::test_string(" Rsh shell ")),
            },
            Example {
                description: "Trim whitespace from the end of string",
                example: "' Rsh shell ' | str trim --right",
                result: Some(Value::test_string(" Rsh shell")),
            },
            Example {
                description: "Trim a specific character",
                example: "'=== Rsh shell ===' | str trim --right --char '='",
                result: Some(Value::test_string("=== Rsh shell ")),
            },
        ]
    }
