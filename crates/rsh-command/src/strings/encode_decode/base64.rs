...
use rsh_cmd_base::input_handler::{operate as general_operate, CmdArgument};
use rsh_engine::CallExt;
use rsh_protocol::ast::{Call, CellPath};
use rsh_protocol::engine::{EngineState, Stack};
use rsh_protocol::{PipelineData, ShellError, Span, Spanned, Value};
...
mod tests {
    ...
    use rsh_protocol::{Span, Spanned, Value};
