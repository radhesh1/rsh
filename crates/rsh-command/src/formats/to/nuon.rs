...
use rsh_engine::get_columns;
use rsh_engine::CallExt;
use rsh_parser::escape_quote_string;
use rsh_protocol::ast::{Call, RangeInclusion};
...
impl Command for ToRshon {
    ...
    fn usage(&self) -> &str {
        "Converts table data into Rshon (Rsh Object Notation) text."
    }
...
pub fn value_to_string(
    ...
    match v {
        ...
        // (could be mistaken for commands by the Rsh parser)
