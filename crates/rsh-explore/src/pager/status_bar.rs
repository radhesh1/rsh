...
use crate::{
    rsh_common::{string_width, rshStyle},
    views::util::{rsh_style_to_tui, set_span},
};
...
impl StatusBar {
    ...
    pub fn set_message_style(&mut self, style: rshStyle) {
        self.text.1 = rsh_style_to_tui(style).add_modifier(Modifier::BOLD);
    }

    pub fn set_ctx1_style(&mut self, style: rshStyle) {
        self.ctx1.1 = rsh_style_to_tui(style).add_modifier(Modifier::BOLD);
    }

    pub fn set_ctx2_style(&mut self, style: rshStyle) {
        self.ctx2.1 = rsh_style_to_tui(style).add_modifier(Modifier::BOLD);
    }

    pub fn set_ctx3_style(&mut self, style: rshStyle) {
        self.ctx3.1 = rsh_style_to_tui(style).add_modifier(Modifier::BOLD);
    }

    pub fn set_background_style(&mut self, style: rshStyle) {
        self.back_s = rsh_style_to_tui(style);
    }
}
