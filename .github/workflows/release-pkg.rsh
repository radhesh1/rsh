...
# Description:
#   A script to do the github release task, need rsh to be installed.
# REF:
...
# 5. $env.GITHUB_WORKSPACE = 'D:\rsh'
# 6. $env.GITHUB_OUTPUT = 'D:\rsh\output\out.txt'
...
# 17. open target\wix\rsh0.74.0-x86_64-pc-windows-msvc.msi | hash sha256
...
# Repo source dir like `/home/runner/work/radhesh1/rsh`
