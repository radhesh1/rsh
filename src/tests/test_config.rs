...
#[test]
fn mutate_rsh_config() -> TestResult {
    run_test_std(
...
#[test]
fn mutate_rsh_config_nested_ls() -> TestResult {
    run_test_std(
...
#[test]
fn mutate_rsh_config_nested_table() -> TestResult {
    run_test_std(
        r#"
...
#[test]
fn mutate_rsh_config_nested_menu() -> TestResult {
    run_test_std(
        r#"
            $env.config.menus = [
                {
...
#[test]
fn mutate_rsh_config_nested_keybindings() -> TestResult {
    run_test_std(
        r#"
...
#[test]
fn mutate_rsh_config_nested_color_nested() -> TestResult {
    run_test_std(
...
#[test]
fn mutate_rsh_config_nested_completion() -> TestResult {
    run_test_std(
...
#[test]
fn mutate_rsh_config_nested_history() -> TestResult {
    run_test_std(
...
#[test]
fn mutate_rsh_config_nested_filesize() -> TestResult {
    run_test_std(
